        ...
        public ActionResult CheckOut(OrderViewModel req)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (cart != null)
                {
                    ...
                    DoAnWeb.Common.Common.SendMail("GiaDungViet", "Đơn hàng #" + order.code, contentCustomer.ToString(), req.email);
                    ...
                    DoAnWeb.Common.Common.SendMail("GiaDungViet", "Đơn hàng mới #" + order.code, contentAdmin.ToString(), ConfigurationManager.AppSettings["EmailAdmin"]);
                    cart.clearCart();
